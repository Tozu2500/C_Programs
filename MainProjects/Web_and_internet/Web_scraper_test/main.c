...
int main(void) {
    ...
    console_print_header(console, "Web Scraper Application for betting sites");
    ...
    console_clear(console);
    console_center_text(console, 10, "Thanks for using the program!");
    console_center_text(console, 11, "Bye bye");
